 ...
 *
 * Nota DNS: si Browserless no puede resolver el dominio del portal, el fallback
 * vía IP está implementado en engine/actions/goto.js (CDP + request interception).
 *
