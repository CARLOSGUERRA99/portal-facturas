  ...
  try {
    ...
    for (const t of atascados) {
      ...
      await db.query(
        ...
        [`El correo con el CFDI de ${t.comercio || "este comercio"} no llegó en 60 minutos. El portal probablemente sí generó la factura — revisa el buzón de correo o reintenta.`, t.id]
      );
