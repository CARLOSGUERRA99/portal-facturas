...
(async () => {
  ...
  console.log('➡️ Click Seleccionar...');
  await page.evaluate(() => {
  ...
  console.log('BODY tras Seleccionar:\n', bodyText);
  ...
  console.log('📸', await subirArchivoR2(buf, `debug/ramcal_post_seleccionar_${Date.now()}.png`, 'image/png'));
