...
(async () => {
  ...
  console.log('➡️ Click real en ACCEDER A FACTURAR...');
  ...
  if (!facturarEl) { console.log('❌ No se encontró el enlace'); await browser.close(); process.exit(1); }
  ...
  console.log('📸', await subirArchivoR2(buf, `debug/oxxogas_form_facturar3_${Date.now()}.png`, 'image/png'));
